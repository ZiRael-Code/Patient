...
import 'package:flutter_app/PinResetSucess.dart';
import 'package:flutter_svg/svg.dart';


void main(){
  runApp(const RetypePin());
}

class RetypePin extends StatefulWidget {
  const RetypePin({super.key});
  @override
                  ...
                  Column(
                    children: [
                      ...
                      Container(
                        ...
                        child:
                        const Align(child: Text("Retype PIN.", textAlign: TextAlign.center,
                          style: TextStyle(
                            fontSize: 16,
                          ),
                        ),
